...
<html lang="pt-BR">
	<head>
        @include('includes.head', array(
            'title' => 'Criar site de farmácia online é com a Espaço Mercado!', 
            'keywords' => 'Farmácia online, Criar site farmácia',
            'description' => 'A Espaço Mercado é especialista em criar sites e oferece diversos serviços exclusivos para sua farmácia online!'
        ))
        <link rel="stylesheet" href="{{ asset('css/farmacia.css') }}">
	</head>
	<body>
						...
						<div class="row">
							<div class="col-md-8 col-lg-8">
								<div class="custom-top-title-box">
									<span class="text-color-light font-weight-semibold">Quer criar um app e site para sua farmácia?</span>
									<h1 class="text-color-light">App para <br> Farmácia</h1>
									<span class="text-color-light font-weight-semibold mb-5 mt-3">Criamos sua loja de farmácia online e já pronta para vender em até 24hs!</span>
								</div>
							</div>
							<div class="col-8 col-md-4 col-lg-4 mx-auto">
								<div class="owl-carousel custom-arrows-style-1 custom-left-pos-1 custom-background-1 m-0" data-plugin-options="{'items': 1, 'loop': true, 'dots': false, 'nav': true, 'autoplay': true, 'autoplayTimeout': 3000}">
									<div>
										<img src="{{ asset('img/em/criar-farmacia-online-site-ecommerce.svg') }}" alt class="img-fluid" />
									</div>	
									<div>
										<img src="{{ asset('img/em/criar-farmacia-online-site-ecommerce2.svg') }}" alt class="img-fluid" />
									</div>	
									<div>
										<img src="{{ asset('img/em/criar-farmacia-online-site-ecommerce3.svg') }}" alt class="img-fluid" />
									</div>
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-lg-8 col-sm-8">
								<p class="text-color-light m-0">
									Aplicativo exemplo de nossas farmácias disponível na PlayStore!
									<span class="pt-0 text-2">Venha conferir como ficará a sua farmácia online.</span>
								</p>
							</div>
								...
								<div class="row justify-content-center">
									<div class="custom-wrap-icons">
										<div class="custom-box-icon">
											...
											<span class="appear-animation" data-appear-animation="fadeInDown" data-appear-animation-delay="1500">Sua Farmácia Online</span>
										</div>
					...
					<div class="container">
						<div class="row mb-5 pb-5 justify-content-center">
							<div class="col-lg-5 text-center">
								<img src="{{ asset('img/em/farmacia-1.png') }}" data-appear-animation="fadeInLeft" data-appear-animation-delay="300" data-plugin-options="{'accY': 200}" alt class="img-fluid" />
							</div>
							<div class="col-md-10 col-lg-7 text-center text-lg-left">
								<h2 class="custom-bar _left text-color-dark">Quer criar um site para ter sua farmácia online?</h2>
								<h4 class="font-weight-normal">A Espaço Mercado é especialista em e-commerce para o setor farmacêutico e oferecemos uma solução completa e integrada para a sua loja!</h4>
							</div>
						</div>
						<div class="row mb-5 pb-5 justify-content-center">
							<div class="col-md-10 col-lg-7 order-2 order-lg-1 text-center text-lg-right">
								...
								<h4 class="font-weight-normal">Tenha seu site e app em Android e iOS exclusivo para sua farmácia com o melhor custo benefício do mercado!</h4>
							</div>
							<div class="col-lg-5 order-1 order-lg-2 text-center">
								<img src="{{ asset('img/em/farmacia-2.png') }}" data-appear-animation="fadeInRight" data-appear-animation-delay="300" data-plugin-options="{'accY': 200}" alt class="img-fluid" />
							</div>
						</div>
						<div class="row mb-5 pb-5 justify-content-center">
							<div class="col-lg-5 text-center">
								<img src="{{ asset('img/em/farmacia-3.png') }}" data-appear-animation="fadeInLeft" data-appear-animation-delay="300" data-plugin-options="{'accY': 200}" alt class="img-fluid" />
							</div>
							<div class="col-md-10 col-lg-7 text-center text-lg-left">
                        ...
                        <div class="row mb-5 pb-5 justify-content-center">
							<div class="col-md-10 col-lg-7 order-2 order-lg-1 text-center text-lg-right">
								<h2 class="custom-bar _right text-color-dark">Venda mais com uma farmácia online</h2>
                        ...
                        <div class="row">
							...
							<div class="row div-mais-sistema-e-infra mt-3">
								...
								<div class="col-lg-4 appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="300">
									<div class="feature-box feature-box-style-2">
										...
										<div class="feature-box-info">
											<h4 class="font-weight-bold mb-2">Venda para todo o Brasil</h4>
											<p>Estamos integrados a várias plataformas de frete e logística. Você consegue vender facilmente para qualquer lugar do Brasil com os melhores preços e transportadoras do mercado.</p>
										</div>
									</div>
								</div>
								<div class="col-lg-4 appear-animation" data-appear-animation="fadeInUpShorter">
                            ...
                            <div class="col-lg-4 appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="300">
                                <div class="feature-box feature-box-style-2">
                                    ...
                                    <div class="feature-box-info">
                                        <h4 class="font-weight-bold mb-2">Integração com Market Place B2W: Americanas, Submarino e Shoptime</h4>
                                        <p></p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="300">
                                <div class="feature-box feature-box-style-2">
                                    ...
                                    <div class="feature-box-info">
                                        <h4 class="font-weight-bold mb-2">Integração com Market Place Via Varejo: Casas Bahia, Ponto Frio e Extra.com.br</h4>
                                        <p></p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="300">
                                <div class="feature-box feature-box-style-2">
                                    <div class="feature-box-icon">
                                        <i class="fas fa-prescription-bottle-alt text-color-primary"></i>
                                    </div>
                                    <div class="feature-box-info">
                                        <h4 class="font-weight-bold mb-2">Integração com Market Place Consulta Remédios</h4>
                                        <p>Participe de um dos principais market places do Brasil! Estamos integrados com o consulta remédios, assim todos os produtos que disponibilizar na plataforma estarão sincronizados com o eles! Sua loja aparecerá para muito mais pessoas além de reforçar ainda mais sua classificação nas pesquisas orgânicas.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 appear-animation" data-appear-animation="fadeInUpShorter">
						...
						<div class="container">
							<div class="row">
								<div class="col-lg-7">
									...
									<p class="text-color-light custom-font-secondary text-4 mb-0">Criamos app para a sua farmácia online tanto para a Android quanto para iOS.</p>
									<p class="text-2 text-color-light custom-font-secondary mb-4 pb-3">Venha conferir o aplicativo exemplo das nossas farmácias disponíveis na PlayStore!</p>
									<div class="row">
					...
					<div class="container desktop">
						<div class="row">
                            ...
                            <div class="col-md-2 card text-center">
                                ...
                                <span class="h6 text-dark font-weight-semibold">por mês</span>
                                <a hrfe="{{ route('contato') }}" class="btn btn-rounded btn-primary mt-1 mb-2">Criar Loja</a>
                            </div>
                            <div class="col-md-2 card text-center d-none">
                                <span class="badge badge-primary badge-xs badge-pill text-uppercase px-2 py-1 mr-1 mt-2">mais vendido</span>
        ...
        @include('includes.scripts', array('pagina' => 'farmacia'))
